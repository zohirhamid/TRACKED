...
class TrackerListView(LoginRequiredMixin, ListView):
    ...
    def get_suggested_trackers(self):
        return [
            # Health & Wellness
            {'name': 'Sleep', 'tracker_type': 'duration', 'icon': '😴', 'unit': 'hours', 'slug': 'sleep'},
            {'name': 'Wake Up', 'tracker_type': 'time', 'icon': '⏰', 'slug': 'wakeup'},
            {'name': 'Mood', 'tracker_type': 'rating', 'icon': '😊', 'min_value': 1, 'max_value': 5, 'slug': 'mood'},
            {'name': 'Water', 'tracker_type': 'number', 'icon': '💧', 'unit': 'glasses', 'slug': 'water'},
            {'name': 'Weight', 'tracker_type': 'number', 'icon': '⚖️', 'unit': 'kg', 'slug': 'weight'},
            {'name': 'Calories', 'tracker_type': 'number', 'icon': '🔥', 'unit': 'kcal', 'slug': 'calories'},
            {'name': 'Steps', 'tracker_type': 'number', 'icon': '👟', 'unit': 'steps', 'slug': 'steps'},
            
            # Fitness
            {'name': 'Exercise', 'tracker_type': 'binary', 'icon': '🏃', 'slug': 'exercise'},
            {'name': 'Gym', 'tracker_type': 'binary', 'icon': '🏋️', 'slug': 'gym'},
            {'name': 'Stretching', 'tracker_type': 'binary', 'icon': '🧘', 'slug': 'stretching'},
            {'name': 'Running', 'tracker_type': 'duration', 'icon': '🏃‍♂️', 'unit': 'mins', 'slug': 'running'},
            
            # Mindfulness & Personal
            {'name': 'Meditate', 'tracker_type': 'binary', 'icon': '🧘', 'slug': 'meditate'},
            {'name': 'Journal', 'tracker_type': 'binary', 'icon': '📓', 'slug': 'journal'},
            {'name': 'Gratitude', 'tracker_type': 'binary', 'icon': '🙏', 'slug': 'gratitude'},
            {'name': 'Prayer', 'tracker_type': 'binary', 'icon': '🤲', 'slug': 'prayer'},
            
            # Productivity
            {'name': 'Read', 'tracker_type': 'binary', 'icon': '📚', 'slug': 'read'},
            {'name': 'Study', 'tracker_type': 'duration', 'icon': '📖', 'unit': 'mins', 'slug': 'study'},
            {'name': 'Work', 'tracker_type': 'duration', 'icon': '💼', 'unit': 'hours', 'slug': 'work'},
            {'name': 'Side Project', 'tracker_type': 'binary', 'icon': '🚀', 'slug': 'sideproject'},
            {'name': 'Learning', 'tracker_type': 'binary', 'icon': '🎓', 'slug': 'learning'},
            
            # Habits to Break
            {'name': 'No Alcohol', 'tracker_type': 'binary', 'icon': '🚫🍺', 'slug': 'noalcohol'},
            {'name': 'No Smoking', 'tracker_type': 'binary', 'icon': '🚭', 'slug': 'nosmoking'},
            {'name': 'No Social Media', 'tracker_type': 'binary', 'icon': '📵', 'slug': 'nosocialmedia'},
            
            # Self-care
            {'name': 'Skincare', 'tracker_type': 'binary', 'icon': '✨', 'slug': 'skincare'},
            {'name': 'Cold Shower', 'tracker_type': 'binary', 'icon': '🚿', 'slug': 'coldshower'},
            {'name': 'Vitamins', 'tracker_type': 'binary', 'icon': '💊', 'slug': 'vitamins'},
            
            # Other
            {'name': 'Notes', 'tracker_type': 'text', 'icon': '📝', 'slug': 'notes'},
            {'name': 'Spending', 'tracker_type': 'number', 'icon': '💰', 'unit': '£', 'slug': 'spending'},
            {'name': 'Call Family', 'tracker_type': 'binary', 'icon': '📞', 'slug': 'callfamily'},
            {'name': 'Cooking', 'tracker_type': 'binary', 'icon': '🍳', 'slug': 'cooking'},
        ]
